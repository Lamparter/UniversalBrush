...
namespace Riverside.UniversalBrush.Core.Editors
{
    public class ColorEditor : Control
    {
        ...
        public static readonly DependencyProperty ColorStringFormatProperty = DependencyProperty.Register("ColorStringFormat", typeof(Riverside.UniversalBrush.Core.Utils.ColorStringFormat), typeof(ColorEditor), new PropertyMetadata(Riverside.UniversalBrush.Core.Utils.ColorStringFormat.PoundRGB, new PropertyChangedCallback(OnColorStringFormatPropertyChanged)));

        private static void OnColorStringFormatPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is ColorEditor target)
            {
                target.OnColorStringFormatChanged((Riverside.UniversalBrush.Core.Utils.ColorStringFormat)e.OldValue, (Riverside.UniversalBrush.Core.Utils.ColorStringFormat)e.NewValue);
            }
        }

        private void OnColorStringFormatChanged(Riverside.UniversalBrush.Core.Utils.ColorStringFormat oldValue, Riverside.UniversalBrush.Core.Utils.ColorStringFormat newValue)
        {
            if (!_internalValueChanging)
            {
                _internalValueChanging = true;
        ...
        public Riverside.UniversalBrush.Core.Utils.ColorStringFormat ColorStringFormat
        {
            get { return (Riverside.UniversalBrush.Core.Utils.ColorStringFormat)GetValue(ColorStringFormatProperty); }
