...
namespace Riverside.UniversalBrush.Core.ColorPalette
{
    ...
    public class ColorPaletteEntry : IColorPaletteEntry
    {
        ...
        public ColorPaletteEntry(Color color, string title, string description, Riverside.UniversalBrush.Core.Utils.ColorStringFormat activeColorStringFormat, IReadOnlyList<ContrastColorWrapper> contrastColors)
        {
            _activeColor = color;
            _title = title;
