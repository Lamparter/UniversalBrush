...
using Windows.UI;
using Riverside.UniversalBrush.Core.Utils;
using System.Collections.Generic;

namespace Riverside.UniversalBrush.Core.ColorPalette
{
    ...
    public class EditableColorPaletteEntry : IColorPaletteEntry
    {
        public static EditableColorPaletteEntry Parse(JsonObject data, IColorPaletteEntry sourceColor, IReadOnlyList<ContrastColorWrapper> contrastColors)
        {
            ...
            Riverside.UniversalBrush.Core.Utils.ColorStringFormat activeColorStringFormat = Riverside.UniversalBrush.Core.Utils.ColorStringFormat.PoundRGB;
            if (data.ContainsKey("ActiveColorStringFormat"))
            {
                activeColorStringFormat = data.GetEnum<Riverside.UniversalBrush.Core.Utils.ColorStringFormat>();
            }
        ...
        public EditableColorPaletteEntry(IColorPaletteEntry sourceColor, Color customColor, bool useCustomColor, string title, string description, Riverside.UniversalBrush.Core.Utils.ColorStringFormat activeColorStringFormat, IReadOnlyList<ContrastColorWrapper> contrastColors)
        {
        ...
        public string ActiveColorString
        {
            get
            {
                return Riverside.UniversalBrush.Core.Utils.ColorUtils.FormatColorString(_activeColor, _activeColorStringFormat);
            }
        }

        private Riverside.UniversalBrush.Core.Utils.ColorStringFormat _activeColorStringFormat = Riverside.UniversalBrush.Core.Utils.ColorStringFormat.PoundRGB;
        public Riverside.UniversalBrush.Core.Utils.ColorStringFormat ActiveColorStringFormat
        {
