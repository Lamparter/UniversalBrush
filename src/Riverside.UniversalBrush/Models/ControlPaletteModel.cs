...
namespace Riverside.UniversalBrush.Models
{
    public class ControlPaletteModel : IControlPaletteModel
    {
        public async Task InitializeData(StringProvider stringProvider, string dataPath)
        {
            ...
            _whiteColor = new ColorPaletteEntry(Colors.White, _stringProvider.GetString("DarkThemeTextContrastTitle"), null, Core.Utils.ColorStringFormat.PoundRGB, null);
            _blackColor = new ColorPaletteEntry(Colors.Black, _stringProvider.GetString("LightThemeTextContrastTitle"), null, Core.Utils.ColorStringFormat.PoundRGB, null);
