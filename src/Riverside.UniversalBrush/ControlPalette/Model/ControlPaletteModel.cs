...
using Riverside.UniversalBrush.Core;
using Riverside.UniversalBrush.Core.ColorPalette;
using System;
...
namespace Riverside.UniversalBrush.ControlPalette.Model
{
    ...
    public class ControlPaletteModel : IControlPaletteModel
    {
        public async Task InitializeData(StringProvider stringProvider, string dataPath)
        {
            ...
            _whiteColor = new ColorPaletteEntry(Colors.White, _stringProvider.GetString("DarkThemeTextContrastTitle"), null, Riverside.UniversalBrush.Core.Utils.ColorStringFormat.PoundRGB, null);
            _blackColor = new ColorPaletteEntry(Colors.Black, _stringProvider.GetString("LightThemeTextContrastTitle"), null, Riverside.UniversalBrush.Core.Utils.ColorStringFormat.PoundRGB, null);
