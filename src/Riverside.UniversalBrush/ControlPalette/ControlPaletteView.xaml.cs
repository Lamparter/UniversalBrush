...
namespace Riverside.UniversalBrush.ControlPalette
{
	public sealed partial class ControlPaletteView : Page
	{
		...
		public partial string ComboboxShapePresetsHeader { get; set; }

		[GeneratedDependencyProperty]
		public partial string DefaultItemText { get; set; }

		[GeneratedDependencyProperty]
		public partial string PreFluent { get; set; }

		[GeneratedDependencyProperty]
		public partial string CornerRadiusSectionHeader { get; set; }

		[GeneratedDependencyProperty]
		public partial string ControlsCornerRadiusSliderHeader { get; set; }

		[GeneratedDependencyProperty]
		public partial string ControlCornerRadiusPreview { get; set; }

		[GeneratedDependencyProperty]
		public partial string OverlayCornerRadiusHeader { get; set; }

		[GeneratedDependencyProperty]
		public partial string OverlayCornerRadiusPreview { get; set; }

		[GeneratedDependencyProperty]
		public partial string OKButtonPreviewText { get; set; }

		[GeneratedDependencyProperty]
		public partial string CancelButtonPreviewText { get; set; }

		[GeneratedDependencyProperty]
		public partial string ControlBorderThicknessSectionHeader { get; set; }

		[GeneratedDependencyProperty]
		public partial string ControlBorderThicknessPreview { get; set; }

		[GeneratedDependencyProperty]
		public partial string ApplyButtonText { get; set; }
	}
}
